...
from src.actions.action_spawner import ActionSpawner
...
class Actions:
    def __init__(self, map: Map):
        ...
        self.__actions_spawner = ActionSpawner(self.__proportion, self.__map)
    ...
    def turn_actions(self) -> None:
        ...
        for entity in list(map.values()):
            if isinstance(entity, Creature):
                ...
                self.__map.update()
        self.__actions_spawner.generate_entities(self.__actions_spawner.calc_cnt_missing_entity(self.__map.calc_entity_on_map()))
